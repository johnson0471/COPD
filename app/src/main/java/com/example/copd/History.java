    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(History.this, "Data : " + int_checkDate, Toast.LENGTH_LONG).show();
                Toast.makeText(History.this, "items_rehabilitation.size(): " + items_rehabilitation.size(), Toast.LENGTH_SHORT).show();
                int_checkDate = 0;
